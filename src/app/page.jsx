    ...
    <Stack>
      {permissionsData?.permissions?.indexOf("s") !== -1 && (
        <>
          ...
          {isLoading ? <Loader color="blue" /> : <Dashboard dashboardData={data} />}
        </>
      )}
      <Text>
        Olá <strong>{userData?.name}</strong>, seja bem-vindo ao painel do Gata Completa.
      </Text>
      ...
      <Group>
        {permissionsData?.permissions?.indexOf("s") !== -1 && (
          <>
            <Button component="a" href="/anuncios">
              Anúncios
            </Button>
            <Button component="a" href="/acompanhantes">
              Acompanhantes
            </Button>
            <Button component="a" href="/usuarios">
              Usuários
            </Button>
          </>
        )}
        {permissionsData?.permissions?.indexOf("g") !== -1 && (
          <>
            <Button component="a" href="/acompanhante">
              Acompanhante
            </Button>
          </>
        )}
